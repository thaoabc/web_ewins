...
class services extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('service')->insert([
            ...
            ['id'=>4,'name'=>'Kiểm tra trực tuyến','content'=>'Đã từ lâu các nhà tâm lý học phát triển các bộ công cụ bằng bảng hỏi để kiểm tra một số khả năng, tiềm năng của con người như khả năng xử lý con số, sử dụng ngôn ngữ, thông minh','slug'=>'Kiem-tra-truc-tuyen','status'=>1,'cate_id'=>4,'image'=>'omt-logo-final1-409x230.jpg'],
        ]);
    }
}
