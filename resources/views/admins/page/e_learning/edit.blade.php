    ...
    <div class="container-fluid">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <form role="form" method="POST" action="{{Route('e_learning.update',['id'=>$e_learning->id])}}"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập tiêu đề tin e-learning"
                                        name="title" value="{{ $e_learning->title }}">
                                    <p style="color:red">{{ $errors->first('title') }}</p>
                                </div>

                                <?php if($e_learning->status ==1){
                                ...
                                <div class="form-group" id="lastImg">
                                    <div>
                                        <img style="width:50px" src="{{asset('assets/img_e_learning/'.$e_learning->icon)}}" alt="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div id="viewImg">
